<div class="col-md-8">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="my-4 latest-ideas" style="font-weight: bold;">Most Downvotes</h1>
            </div>
            <div class="col-sm-6">
        ...
        $results = mysqli_query($conn, "SELECT * FROM idea ORDER BY downvote_count DESC LIMIT $offset, $no_of_records_per_page");
